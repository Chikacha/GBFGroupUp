...
class MemberListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create member_list" do
    assert_difference('MemberList.count') do
      post member_lists_url, params: { member_list: { combat_capabilities: @member_list.combat_capabilities, name_in_discord: @member_list.name_in_discord, name_in_game: @member_list.name_in_game, needMVP: @member_list.needMVP, notes: @member_list.notes, player_attribute: @member_list.player_attribute, player_exability: @member_list.player_exability, player_id: @member_list.player_id, player_job: @member_list.player_job } }
    end
  ...
  test "should update member_list" do
    patch member_list_url(@member_list), params: { member_list: { combat_capabilities: @member_list.combat_capabilities, name_in_discord: @member_list.name_in_discord, name_in_game: @member_list.name_in_game, needMVP: @member_list.needMVP, notes: @member_list.notes, player_attribute: @member_list.player_attribute, player_exability: @member_list.player_exability, player_id: @member_list.player_id, player_job: @member_list.player_job } }
